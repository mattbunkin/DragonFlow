<script lang="ts">
    ...
    import CustomButton from './CustomButton.svelte';
     ...
     import { cn } from "$lib/utils";
                    ...
                    import Circle from "$lib/components/ui/animation/Circle.svelte";
                    let containerRef;
                    // Circles
                    let div1Ref;
                    let div2Ref;
    ...
    function goToLogin(){
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 p-5 mb-10 mt-10">
            ...
            <div class="flex flex-col content-center ml-8 mb-14">
                <h1 class="font-light text-5xl mt-8">
                    Effortless course scheduling, tailored just for <p class="underline text-sky-400">you.</p>
                </h1>
            </div>
            ...
            <div class="flex flex-col content-center ml-8">
                  ...
                  <div
                    ...
                    class={cn(
                      "relative flex w-full max-w-[650px] items-center justify-center overflow-hidden rounded-lg border bg-background p-10  md:shadow-xl dark:shadow-[#090909]",
                      className
                    )}
                  >
                    ...
                    >
                      <div class="flex flex-col justify-center gap-2">
                        <!-- Div 1 -->
                        <Circle>
                            <NotebookPen class="relative h-96 w-96"></NotebookPen> 
                          <svg
                            bind:this={div1Ref}
                            viewBox="0 0 256 308"
                            width="40"
                        ...
                        <Circle>
                              <!--Add Icon -->
                          <Sigma class="relative h-96 w-96"></Sigma> 
                          <svg
                            bind:this={div2Ref}
                            xmlns="http://www.w3.org/2000/svg"
                            width="40"
                        ...
                        <!-- Div 3 -->
                        <Circle>
                            <FlaskConical class="relative h-96 w-96"></FlaskConical> 
                          <svg
                            bind:this={div3Ref}
                            width="30"
                            height="30"
                        ...
                        <!-- Div 4 -->
                        <Circle>
                            <Earth class="relative h-96 w-96"></Earth>
                          <svg
                            bind:this={div4Ref}
                            height="16"
                            xmlns="http://www.w3.org/2000/svg"
                        ...
                        <!-- Div 5 -->
                        <Circle>
                            <Binary class="relative h-96 w-96"></Binary>
                          <svg
                            bind:this={div5Ref}
                            xmlns="http://www.w3.org/2000/svg"
                            width="100%"
                      ...
                      <div class="flex flex-col justify-center">
                        ...
                        <Circle>
                          ...
                          >
                        <!--Add Icon -->
                        <CalendarDays class="relative h-96 w-96"/>
                        </Circle>
                      </div>
    ...
    .glow:hover{
        ...
        box-shadow:  0 0 9px 2px rgb(143, 210, 243);
    }
    .glow{
